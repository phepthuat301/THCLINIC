...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2021 at 06:14 AM
...
INSERT INTO `quantrivien` (`id_qtv`, `username`, `password`, `role`, `token`) VALUES
(1, 'drsol', '25f9e794323b453885f5181f1b624d0b', 'admin', '4adc3b69264feb612d6448746569c038fe3d4528');
...
--
ALTER TABLE `quantrivien`
  MODIFY `id_qtv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
