...
export const getRevenueAction = (year) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/doanhthu/${year}`);
    dispatch({
...
export const getOrderTotalAction = (year) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/tongsoluong/${year}`);
    dispatch({
...
export const getDayRevenueAction = (month, year) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`http://localhost:3001/doanhthungay`, {
      month,
      year,
    });
    dispatch({
...
export const getDayOrderTotalAction = (month, year) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`http://localhost:3001/tongsoluongngay`, {
      month,
      year,
    });
    dispatch({
...
export const getTotalRevenueAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/tongdoanhthu`);
    dispatch({
...
export const getUserInMonthAction = (year) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/userinmonth/${year}`);
    dispatch({
...
export const get30daysAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:3001/30days`);
    dispatch({
